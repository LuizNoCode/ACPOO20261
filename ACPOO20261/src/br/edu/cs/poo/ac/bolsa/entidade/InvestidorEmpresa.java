...
public class InvestidorEmpresa extends Investidor {
    ...
    public InvestidorEmpresa(String nome, Endereco endereco, LocalDate dataAbertura, BigDecimal bonus, Contatos contatos,
    ...
    public BigDecimal getEntradaFinanceira() {
        return BigDecimal.valueOf(this.faturamento);
    }
}